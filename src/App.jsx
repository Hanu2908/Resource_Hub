...
export default function App() {
  ...
  // Apply theme and refresh countdowns every 30s
  useEffect(() => {
    applyTheme(THEME);
  ...
  // Compute filtered exams with countdown baked in
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ fontFamily: "'Bebas Neue', cursive", fontSize: "30px", letterSpacing: "3px", color: "var(--accent)", lineHeight: 1 }}>
              {APP_TITLE}
            </div>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "9px", color: "var(--text-meta)", letterSpacing: "1px", marginTop: "3px", textTransform: "uppercase" }}>
              {APP_SUBTITLE}
            </div>
          </div>
          <div style={{ textAlign: "right" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "5px", fontFamily: "'IBM Plex Mono', monospace", fontSize: "9px", letterSpacing: "2px", color: "var(--status-live)" }}>
              <span className="live-dot" style={{ width: "6px", height: "6px", background: "var(--status-live)", borderRadius: "50%", display: "inline-block" }} />
              LIVE
            </div>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "9px", color: "var(--border-strong)", marginTop: "3px" }}>
      ...
      {/* ── BRANCH FILTER ── */}
      <div style={{ display: "flex", gap: "5px", padding: "9px 16px", borderBottom: "1px solid var(--border-faint)", overflowX: "auto" }}>
        {BRANCHES.map(b => (
          <button
            key={b.code}
